...
var CalendarController = /** @class */ (function () {
    ...
    CalendarController.prototype.getEvents = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, month, year, events, error_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, calendar_service_1.calendarService.getMonthEvents(userId, month, year)];
                    case 1:
                        events = _b.sent();
                        return [2 /*return*/, res.json(events)];
                    case 2:
                        error_1 = _b.sent();
                        console.error('Error getting calendar events:', error_1);
