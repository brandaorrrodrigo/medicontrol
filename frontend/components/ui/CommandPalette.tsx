...
const createDefaultCommands = (router: any, theme: any): Command[] => [
  ...
  },
  {
    ...
    action: () => router.push('/patient/vitals'),
  ...
  },
  {
    ...
    action: () => router.push('/patient/exams'),
  ...
  // Actions
  {
    ...
    icon: <Pill className="w-5 h-5" />,
    action: () => router.push('/patient/medications?new=true'),
  ...
  },
  {
    ...
    action: () => router.push('/patient/vitals?new=true'),
  ...
  },
  {
    ...
    icon: <FileText className="w-5 h-5" />,
    action: () => router.push('/patient/exams?new=true'),
  ...
  // Gamification
  {
    ...
    action: () => router.push('/patient/achievements'),
  ...
  },
  {
    ...
    action: () => router.push('/patient/streak'),
