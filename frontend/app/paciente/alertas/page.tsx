      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Gerencie seus alertas medicamentosos</p>
              </div>
            </div>
        ...
        {loading ? (
          <div className="text-center py-12">
            <RefreshCwIcon className="w-8 h-8 text-gray-400 animate-spin mx-auto mb-4" />
            <p className="text-gray-600">Carregando alertas...</p>
          </div>
        ) : error ? (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
            <p className="text-red-600">{error}</p>
            <button onClick={loadAlerts} className="mt-2 text-red-600 underline">
              Tentar novamente
            </button>
          </div>
        ) : alerts.length === 0 ? (
          <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600">Você não possui alertas no momento.</p>
          </div>
        ) : (
              ...
              return (
                <div
                  ...
                  className={`bg-white rounded-lg border p-4 transition-all ${
                    !alert.read ? 'border-l-4 border-l-amber-500 bg-amber-50' : 'border-gray-200'
